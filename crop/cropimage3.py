...
def image_cut(path_name, id, box_w, box_h):
    ...
    # box_w：要剪切的图形的宽度
    # box_h：要剪切的图形的高度
    name = os.path.join(path_name, str(id) + ".png")  # 要剪切图像的名字
    im = Image.open(name)
...
path_name = "E:/Smart Image Project/Images Classification/pytorch_hand_classifier-master/data/images/1"  # 要剪切的图像的文件夹路径 /home/li/data/data1(crop)/train/aug_gt_scale_0.9/

for item in os.listdir(path_name):
    id = item.split('.')[0]
    image_cut(path_name, id, box_w=50, box_h=50)